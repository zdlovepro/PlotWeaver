...
DEFAULT_PARAGRAPH_TARGET_CHARS = 64
MIN_PARAGRAPH_TARGET_CHARS = 45
...
def _apply_character_budgets(program: ChapterProgram, target_chars: int) -> ChapterProgram:
    ...
    for scene in program.scene_programs:
        ...
        for paragraph in scene.paragraphs:
            ...
            revised.append(replace(paragraph, target_chars=target, minimum_chars=max(35, round(target * 0.7))))
            offset += 1
